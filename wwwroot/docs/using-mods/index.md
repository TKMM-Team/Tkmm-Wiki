...
If you are using another emulator, click the <kbd><samp>+</samp></kbd> <sup>[(3)](./images/ExportLocations.png)</sup> button and paste the path to a **$${\color{red}TKMM}$$ $${\color{red}subfolder}$$** in your emulator's mod folder.
